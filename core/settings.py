...
SECRET_KEY = 'django-insecure-n5gw2)%pa1zvjan#w$av9xd*!63xx5(vjux4z#81cibl*4c3nu'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'rest_framework.authtoken', # Needed for login
    'corsheaders',              # Needed for React/Mobile connection
    'api',
]
